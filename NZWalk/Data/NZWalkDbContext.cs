    ...
    public class NZWalkDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var difficulties = new List<Difficulty>()
            {
                new Difficulty()
                {
                    Id = Guid.Parse("0b6d7280-7c69-4616-9375-b670806989b4"),
                    Name = "Easy" ,
                },
                new Difficulty()
                {
                    Id = Guid.Parse("6cdad7e1-374b-4def-a6b8-04ba4a54d696"),
                    Name = "Medium" ,
                },
                new Difficulty()
                {
                    Id = Guid.Parse("c0733a03-6713-44f3-987b-51c7c193f631"),
                    Name = "Hard" ,
                }
            };

            //Seed data for difficulties to the database
